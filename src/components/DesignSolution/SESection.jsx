      ...
      <div className="absolute inset-x-0 bg-[#2D3A2D] p-16 md:p-32 text-white flex flex-col justify-end items-end ">
        ...
        <div className="flex justify-center mt-4">
          <button
            ...
            className="absolute lg:top-28 right-6 sm:right-4 md:right-24 lg:right-72 mt-4 lg:mt-16 bg-[#9C0300] text-white hover:bg-red-700 transition-colors p-1 md:px-4 md:py-1 lg:px-6 lg:py-1 rounded-full text-xs sm:text-xs md:text-base my-2 cursor-pointer"
          >
            SPEAK TO OUR EXPERT
          </button>
        </div>
