        ...
        <div className="w-full lg:max-w-[85%] mx-auto px-4 flex flex-col md:flex-row md:justify-between">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 text-sm text-black py-6 w-full">
            <div className="mb-4">
              ...
              >
                <h3 className="font-bold cursor-pointer mb-2 tracking-wide">
                  FIND A STORE
                </h3>
              </button>
              ...
              <button
                onClick={() => handleScroll("feedbackRef")}
                className="block w-full text-left"
              >
                <h3 className="font-bold cursor-pointer mb-2 tracking-wide">
                  SEND YOUR FEEDBACK
              ...
              <p className="mt-12 text-xs">
                &copy; TBC All Rights Reserved 2024
              </p>
            </div>
            <div className="mb-4 tracking-wide">
              ...
              <Link to={"/shipping-delivery"} className="mb-2 w-fit block">
                Shipping & Delivery
              </Link>
            ...
            <Link to="/page#sustainability"><p>Sustainability</p></Link> */}
              ...
              {/* using href */}
              <button onClick={() => handleScroll("aboutusRef")}>
                <p className="cursor-pointer mb-2">About TH</p>
              </button>
              <br />
              <button onClick={() => handleScroll("newsRef")}>
                <p className="cursor-pointer mb-2">News</p>
              </button>
              <br />
              <button onClick={() => handleScroll("sustainabilityRef")}>
                <p className="cursor-pointer mb-2">Sustainability</p>
              </button>
            </div>
            <div className="mb-4 tracking-wide">
              <h3 className="font-bold mb-2">CONTACT US</h3>
              {/* <p className="mb-2 break-words">info@teakheirlooms.com</p> */}
              <a
                href="mailto:info@teakheirlooms.com"
                className="mb-2 break-words block w-fit"
                aria-label="Send an email to Teak Heirlooms"
              >
                info@teakheirlooms.com
              </a>
              <a href="tel:+917339574747">+91 7339574747</a>
            </div>
          </div>
          <div className="flex flex-col items-center md:items-end w-full md:w-auto text-center md:text-right">
            <div className="flex gap-2 mb-4">
              ...
              <a
                href="https://www.instagram.com/teak.heirlooms?igsh=cnNudmhmM3p4ZHo="
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/1MJuQhxWym/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-2xl"
              >
