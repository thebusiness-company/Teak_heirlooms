  ...
  return (
    <div className="w-full mx-auto flex flex-row flex-nowrap items-center justify-center bg-white mt-8 overflow-hidden">
      ...
      <div className="w-1/3 text-center py-4 px-4">
        ...
        <a
          href={banner.url || "#"}
          target={banner.url?.startsWith("http") }
          rel="noopener noreferrer"
          className="inline-block text-xs md:text-base mt-3 bg-[#9C0300] text-white px-4 py-0.5 md:px-6 md:py-2 md:mt-20 rounded-2xl hover:bg-red-800 transition duration-300 leading-snug whitespace-nowrap cursor-pointer"
        >
          Shop Now
        </a>
