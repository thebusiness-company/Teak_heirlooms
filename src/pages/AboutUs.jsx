  ...
  return (
    <div className="w-full">
      ...
      <div className="py-10 px-6 md:px-14 mt-4 mb-4 ">
        <h2 className="text-3xl lg:text-4xl 2xl:text-[55px] mb-4 md:mb-8 lg:mb-10 text-[#3B493F] text-center">
          ABOUT US
        </h2>
        <p className="text-sm md:text-base 2xl:text-xl w-full lg:max-w-[85%] mx-auto">
        ...
        <p className="text-sm md:text-base 2xl:text-xl w-full lg:max-w-[85%] mx-auto mt-2 md:mt-4 lg:mt-6">
        ...
        <p className="text-sm md:text-base 2xl:text-xl w-full lg:max-w-[85%] mx-auto mt-2">
      ...
      <div className="bg-[#F5E8D9] py-10 px-6 md:px-14">
        <h2 className="text-3xl lg:text-4xl 2xl:text-[55px] text-center text-[#3B493F] mb-8 lg:mb-16">
          OUR STORY
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 lg:gap-14 w-full lg:max-w-[90%] mx-auto mt-6 mb-10">
          <img
            ...
            loading="lazy"
            className="w-full h-56 xl:h-62 2xl:h-84 object-cover "
          />
          <img
            src={a3}
        ...
        <div className=" mt-6">
          <p className="text-sm md:text-base 2xl:text-xl w-full lg:max-w-[90%] mx-auto">
