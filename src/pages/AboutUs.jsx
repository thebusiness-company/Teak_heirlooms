  ...
  return (
    <div className="w-full">
      ...
      <div className="py-10 px-6 md:px-20 text-center">
        ...
        <p className="text-sm md:text-base max-w-3xl mx-auto mt-2">
      ...
      <div className="bg-[#F5E8D9] py-10 px-6 md:px-20">
        <h2 className="text-3xl lg:text-4xl text-center text-[#3B493F] mb-6">
          OUR STORY
        </h2>
        ...
        <div className=" mt-6">
          <p className="text-sm md:text-base max-4xl mx-auto">
